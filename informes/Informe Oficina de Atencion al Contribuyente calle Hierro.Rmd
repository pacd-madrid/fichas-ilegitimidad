...
***Auditoría Ciudadana del Ayuntamiento de Madrid***    
**Distrito: Arganzuela**  
...
**Evolución de la Deuda del Ayuntamiento de Madrid**
```{r deuda_madrid, fig.width=8, fig.align='center'}
require(plotly)
...
_Fuente: Elaboración propia a partir de los datos del Banco de España._
...
```{r map, fig.height=4, fig.align='center'}
require(leaflet)
m <- leaflet() %>%
